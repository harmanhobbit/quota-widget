<script>
  ...
  const PROVIDERS = [
    ...
    { id: 'hermes', name: 'Nous', mode: 'cookie', secretLabel: 'Portal session cookie', note: 'Paste a portal.nousresearch.com session cookie. No local executable, SSH or Tailscale is used.' },
