...
- **Right-click** for Open / Refresh now / Settings / Quit. **Open** shows the
  ...
  **Settings** puts you back where you were when you leave it — via Save &
  close, the ← back arrow, or Esc. Opened from the usage list you return to the
  usage list; opened from the tray while the mini summary was up, the summary
  comes back (pinned or not); opened from the tray with nothing on screen, you
  end with nothing on screen. Back and Esc discard unsaved edits — Save & close
